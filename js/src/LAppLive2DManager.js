...
{
    var mmIdx = localStorage.getItem("modelIdx");
    if(mmIdx == null) mmIdx = 17;
    this.models = [];  
    this.modelIdx = parseInt(mmIdx);
    this.modelName = ModelsDefine[this.modelIdx];
...
LAppLive2DManager.prototype.changeModel = function(gl)
{
    ...
    this.createModel().load(gl, this.modelName);
};
